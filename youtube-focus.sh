...
if pgrep -x "Comet" > /dev/null; then
    # Comet is running, focus YouTube Focus tab or open new tab
...
tell application "Comet"
    ...
    if currentTabURL is not "" then
        if currentTabURL contains "youtube.com" or currentTabURL contains "www.youtube.com" then
    ...
    if foundTab then
        ...
        set newTab to make new tab at end of tabs of frontWindow with properties {URL:"https://www.youtube.com/"}
...
APPLESCRIPT_EOF
    ...
    open -a Comet "https://www.youtube.com/"
fi
