...
if pgrep -x "Comet" > /dev/null; then
    # Comet is running, focus Toggle Inbox tab or open new tab
...
tell application "Comet"
    ...
    if currentTabURL is not "" then
        if currentTabURL contains "discord.com/channels/1477629838880931941/1477629953666191360" then
    ...
    repeat with w from 1 to (count of windows)
        ...
        repeat with t from 1 to (count of windowTabs)
            try
                ...
                if tabURL contains "discord.com/channels/1477629838880931941/1477629953666191360" then
    ...
    if foundTab then
        ...
        set newTab to make new tab at end of tabs of frontWindow with properties {URL:"https://discord.com/channels/1477629838880931941/1477629953666191360"}
