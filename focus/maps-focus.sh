...
# @raycast.title Google Maps Focus
# @raycast.mode silent
...
if pgrep -x "Comet" > /dev/null; then
    # Comet is running, focus Google Maps Focus tab or open new tab
...
tell application "Comet"
    ...
    if currentTabURL is not "" then
        if currentTabURL contains "maps.google.com" or currentTabURL contains "google.com/maps" then
    ...
    repeat with w from 1 to (count of windows)
        ...
        repeat with t from 1 to (count of windowTabs)
            try
                ...
                if tabURL contains "maps.google.com" or tabURL contains "google.com/maps" then
    ...
    if foundTab then
        ...
        set newTab to make new tab at end of tabs of frontWindow with properties {URL:"https://maps.google.com"}
