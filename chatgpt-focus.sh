...
if pgrep -x "Comet" > /dev/null; then
    # Comet is running, focus ChatGPT Focus tab or open new tab
...
tell application "Comet"
    ...
    if currentTabURL is not "" then
        if currentTabURL contains "chat.openai.com" or currentTabURL contains "chatgpt.com" then
    ...
    if foundTab then
        ...
        set newTab to make new tab at end of tabs of frontWindow with properties {URL:"https://chatgpt.com"}
...
APPLESCRIPT_EOF
    ...
    open -a Comet "https://chatgpt.com"
fi
