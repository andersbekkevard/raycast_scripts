...
if pgrep -x "Comet" > /dev/null; then
    # Comet is running, focus Todoist Focus tab or open new tab
...
tell application "Comet"
    ...
    if currentTabURL is not "" then
        if currentTabURL contains "app.todoist.com" or currentTabURL contains "todoist.com" then
    ...
    repeat with w from 1 to (count of windows)
        ...
        repeat with t from 1 to (count of windowTabs)
            try
                ...
                if tabURL contains "app.todoist.com" or tabURL contains "todoist.com" then
    ...
    if foundTab then
        ...
        set newTab to make new tab at end of tabs of frontWindow with properties {URL:"https://app.todoist.com/app/project/studie-6RWxW3r5GcXRrr8v"}
...
APPLESCRIPT_EOF
    ...
    open -a Comet "https://app.todoist.com/app/project/studie-6RWxW3r5GcXRrr8v"
fi
