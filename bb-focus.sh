...
# @raycast.title Blackboard Focus
# @raycast.mode silent
...
tell application "Comet"
    ...
    if currentTabURL is not "" then
        if currentTabURL contains "blackboard.com" or currentTabURL contains "ntnu.blackboard.com" then
...
APPLESCRIPT_EOF
    ...
    open -a Comet "https://ntnu.blackboard.com"
fi
