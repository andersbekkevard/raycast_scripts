...
if pgrep -x "Comet" > /dev/null; then
    # Comet is running, focus GitHub Focus tab or open new tab
...
tell application "Comet"
    ...
    if currentTabURL is not "" then
        if currentTabURL contains "github.com" then
    ...
    if foundTab then
        ...
        set newTab to make new tab at end of tabs of frontWindow with properties {URL:"https://github.com"}
